import { __commonJS, require_react } from "./chunk-BJFMU22U.js";
  ...
  "node_modules/.deno/scheduler@0.23.0/node_modules/scheduler/cjs/scheduler.development.js"(
    ...
    if (true) {
      (function () {
        ...
        var hasPerformanceNow = typeof performance === "object" &&
    ...
    if (true) {
      (function () {
        ...
        function setCurrentFiber(fiber) {
          {
            ReactDebugCurrentFrame.getCurrentStack = fiber === null
              ? null
        ...
        function updateWrapper(element, props) {
          var node = element;
          {
            ...
            if (
              !node._wrapperState.controlled && controlled &&
          ...
          function (node, html) {
            if (node.namespaceURI === SVG_NAMESPACE) {
              if (!("innerHTML" in node)) {
                ...
                reusableSVGContainer.innerHTML = "<svg>" +
                  html.valueOf().toString() + "</svg>";
        ...
        var setTextContent = function (node, text) {
          if (text) {
            ...
            if (
              firstChild && firstChild === node.lastChild &&
        ...
        function dangerousStyleValue(name, value, isCustomProperty) {
          ...
          if (
            !isCustomProperty && typeof value === "number" && value !== 0 &&
        ...
        function createDangerousStringForStyles(styles) {
          {
            ...
            for (var styleName in styles) {
              ...
              if (styleValue != null) {
                ...
                serialized += delimiter + (isCustomProperty
                  ? styleName
          ...
          validateProperty$1 = function (tagName, name, value, eventRegistry) {
            ...
            if (eventRegistry != null) {
              ...
              var registrationName =
                possibleRegistrationNames2.hasOwnProperty(lowerCasedName)
          ...
          if (
            ...
            invokeGuardedCallbackImpl = function invokeGuardedCallbackDev(
              ...
              function handleWindowError(event) {
                ...
                didSetError = true;
                if (
                  error2 === null && event.colno === 0 && event.lineno === 0
                ) {
        ...
        function markComponentPassiveEffectMountStarted(fiber) {
          {
            if (
              ...
              typeof injectedProfilingHooks
                  .markComponentPassiveEffectMountStarted === "function"
            ) {
        ...
        function markComponentPassiveEffectUnmountStarted(fiber) {
          {
            if (
              injectedProfilingHooks !== null &&
              typeof injectedProfilingHooks
                  .markComponentPassiveEffectUnmountStarted === "function"
            ) {
        ...
        function markComponentLayoutEffectMountStarted(fiber) {
          {
            if (
              injectedProfilingHooks !== null &&
              typeof injectedProfilingHooks
                  .markComponentLayoutEffectMountStarted === "function"
            ) {
        ...
        function markComponentLayoutEffectUnmountStarted(fiber) {
          {
            if (
              injectedProfilingHooks !== null &&
              typeof injectedProfilingHooks
                  .markComponentLayoutEffectUnmountStarted === "function"
            ) {
        ...
        function getNextLanes(root2, wipLanes) {
          ...
          if (
            wipLanes !== NoLanes && wipLanes !== nextLanes &&
        ...
        function includesBlockingLane(root2, lanes) {
          var SyncDefaultLanes = InputContinuousHydrationLane |
            InputContinuousLane | DefaultHydrationLane | DefaultLane;
        ...
        function markRootEntangled(root2, entangledLanes) {
          ...
          while (lanes) {
            ...
            var lane = 1 << index2;
            if (
              lane & entangledLanes | entanglements[index2] & entangledLanes
            ) {
        ...
        var canUseTextInputEvent = canUseDOM && "TextEvent" in window &&
          !documentMode;
        var useFallbackCompositionData = canUseDOM &&
        ...
        function getTargetInstForInputEventPolyfill(domEventName, targetInst) {
          if (
            domEventName === "selectionchange" || domEventName === "keyup" ||
        ...
        function extractEvents$2(
          ...
          var isOverEvent = domEventName === "mouseover" ||
            domEventName === "pointerover";
          var isOutEvent = domEventName === "mouseout" ||
        ...
        function getModernOffsetsFromPoints(
          ...
          while (true) {
            ...
            while (true) {
              ...
              if (
                parentNode === focusNode && ++indexWithinFocus === focusOffset
              ) {
                end = length;
              }
        ...
        var skipSelectionChangeEvent = canUseDOM &&
        ...
        function constructSelectEvent(
          ...
          if (
            mouseDown || activeElement$1 == null ||
        ...
        var ANIMATION_ITERATION = getVendorPrefixedEventName(
          "animationiteration",
        );
        ...
        function registerSimpleEvents() {
          for (var i = 0; i < simpleEventPluginEvents.length; i++) {
            ...
            var capitalizedEvent = eventName[0].toUpperCase() +
              eventName.slice(1);
        ...
        function listenToNativeEvent(
          ...
          {
            if (
              nonDelegatedEvents.has(domEventName) && !isCapturePhaseListener
            ) {
              error(
        ...
        var listeningMarker = "_reactListening" +
        ...
        function addTrappedEventListener(
          ...
          if (passiveBrowserEventsSupported) {
            if (
              domEventName === "touchstart" || domEventName === "touchmove" ||
              domEventName === "wheel"
            ) {
        ...
        function getLowestCommonAncestor(instA, instB) {
          ...
          while (depth--) {
            if (
              nodeA === nodeB || nodeB !== null && nodeA === nodeB.alternate
            ) {
              return nodeA;
            }
            nodeA = getParent(nodeA);
        ...
        function diffProperties(
          ...
          for (propKey in nextProps) {
            ...
            if (
              !nextProps.hasOwnProperty(propKey) || nextProp === lastProp ||
        ...
        function updateProperties(
          ...
          if (
            tag === "input" && nextRawProps.type === "radio" &&
        ...
        function diffHydratedProperties(
          ...
          for (var propKey in rawProps) {
            ...
            if (propKey === CHILDREN) {
              ...
              shouldWarnDev && true && typeof isCustomComponentTag === "boolean"
            ) {
              ...
              if (rawProps[SUPPRESS_HYDRATION_WARNING] === true);
                ...
                propKey === SUPPRESS_CONTENT_EDITABLE_WARNING ||
                propKey === SUPPRESS_HYDRATION_WARNING || propKey === "value" ||
                propKey === "checked" || propKey === "selected"
              );
              else if (propKey === DANGEROUSLY_SET_INNER_HTML) {
                ...
                if (
                  !dontWarnCustomElement && nextProp !== serverValue &&
        ...
        };
        {
          ...
          updatedAncestorInfo = function (oldInfo, tag) {
            ...
            if (
              specialTags.indexOf(tag) !== -1 && tag !== "address" &&
              tag !== "div" && tag !== "p"
            ) {
          ...
          var isTagValidWithParent = function (tag, parentTag) {
            switch (parentTag) {
              ...
              case "option":
                return tag === "#text";
              case "tr":
                return tag === "th" || tag === "td" || tag === "style" ||
                  tag === "script" || tag === "template";
              case "tbody":
              case "thead":
              case "tfoot":
                return tag === "tr" || tag === "style" || tag === "script" ||
                  tag === "template";
              case "colgroup":
                return tag === "col" || tag === "template";
              case "table":
                return tag === "caption" || tag === "colgroup" ||
                  tag === "tbody" || tag === "tfoot" || tag === "thead" ||
                  tag === "style" || tag === "script" || tag === "template";
              case "head":
                return tag === "base" || tag === "basefont" ||
                  tag === "bgsound" || tag === "link" || tag === "meta" ||
                  tag === "title" || tag === "noscript" || tag === "noframes" ||
                  tag === "style" || tag === "script" || tag === "template";
              case "html":
        ...
        function shouldSetTextContent(type, props) {
          return type === "textarea" || type === "noscript" ||
            typeof props.children === "string" ||
            typeof props.children === "number" ||
            typeof props.dangerouslySetInnerHTML === "object" &&
        ...
        var scheduleMicrotask = typeof queueMicrotask === "function"
          ...
          ? function (callback) {
            return localPromise.resolve(null).then(callback).catch(
        ...
        function unhideInstance(instance, props) {
          ...
          var display = styleProp !== void 0 && styleProp !== null &&
        ...
        function getEventListenerSet(node) {
          ...
          if (elementListenerSet === void 0) {
            elementListenerSet =
              node[internalEventHandlersKey] = /* @__PURE__ */
                new Set();
          }
        ...
        function getMaskedContext(workInProgress2, unmaskedContext) {
          {
            ...
            {
              var name = getComponentNameFromFiber(workInProgress2) ||
                "Unknown";
        ...
        function prepareToHydrateHostSuspenseInstance(fiber) {
          var suspenseState = fiber.memoizedState;
          var suspenseInstance = suspenseState !== null
            ? suspenseState.dehydrated
            : null;
          if (!suspenseInstance) {
            throw new Error(
        ...
        function popToNextHostParent(fiber) {
          ...
          while (
            parent !== null && parent.tag !== HostComponent &&
            parent.tag !== HostRoot && parent.tag !== SuspenseComponent
          ) {
        ...
        function propagateContextChange_eager(
          ...
          while (fiber !== null) {
            ...
            if (list !== null) {
              ...
              nextFiber = fiber.type === workInProgress2.type
                ? null
                : fiber.child;
        ...
        function getStateFromUpdate(
          ...
          switch (update.tag) {
            ...
            case CaptureUpdate: {
              workInProgress2.flags = workInProgress2.flags & ~ShouldCapture |
                DidCapture;
            }
            case UpdateState: {
        ...
        function applyDerivedStateFromProps(
          ...
          var memoizedState = partialState === null || partialState === void 0
            ? prevState
        ...
        function callComponentWillReceiveProps(
          ...
          if (instance.state !== oldState) {
            {
              var componentName = getComponentNameFromFiber(workInProgress2) ||
                "Component";
        ...
        function resumeMountClassInstance(
          ...
          if (
            oldProps === newProps && oldState === newState &&
        ...
        function updateClassInstance(
          ...
          var oldProps = workInProgress2.type === workInProgress2.elementType
            ? unresolvedOldProps
        ...
        function coerceRef(returnFiber, current2, element) {
          ...
          if (
            mixedRef !== null && typeof mixedRef !== "function" &&
            typeof mixedRef !== "object"
          ) {
            {
              if (
                (returnFiber.mode & StrictLegacyMode || warnAboutStringRefs) &&
                !(element._owner && element._self &&
            ...
            if (element._owner) {
              ...
              if (!inst) {
                throw new Error(
                  "Missing owner for string ref " + mixedRef +
              ...
              if (
                current2 !== null && current2.ref !== null &&
              ...
              if (!element._owner) {
                throw new Error(
                  "Element ref was specified as a string (" + mixedRef +
        ...
        function ChildReconciler(shouldTrackSideEffects) {
          ...
          function updatePortal(returnFiber, current2, portal, lanes) {
            if (
              current2 === null || current2.tag !== HostPortal ||
          ...
          function updateFromMap(
            ...
            if (typeof newChild === "object" && newChild !== null) {
              switch (newChild.$$typeof) {
                case REACT_ELEMENT_TYPE: {
                  var _matchedFiber = existingChildren.get(
                ...
                case REACT_PORTAL_TYPE: {
                  var _matchedFiber2 = existingChildren.get(
                    newChild.key === null ? newIdx : newChild.key,
                  ) || null;
                  return updatePortal(
                    returnFiber,
          ...
          function reconcileSingleTextNode(
            ...
            if (
              currentFirstChild !== null && currentFirstChild.tag === HostText
            ) {
          ...
          function reconcileChildFibers2(
            ...
            var isUnkeyedTopLevelFragment = typeof newChild === "object" &&
              newChild !== null && newChild.type === REACT_FRAGMENT_TYPE &&
              newChild.key === null;
            ...
            if (!didWarnAboutMismatchedHooksForComponent.has(componentName)) {
              ...
              if (hookTypesDev !== null) {
                ...
                for (var i = 0; i <= hookTypesUpdateIndexDev; i++) {
                  ...
                  var newHookName = i === hookTypesUpdateIndexDev
                    ? currentHookName
                    : oldHookName;
        ...
        function renderWithHooks(
          ...
          currentlyRenderingFiber$1 = workInProgress2;
          {
            ...
            ignorePreviousDependencies = current2 !== null &&
          ...
          var didRenderTooFewHooks = currentHook !== null &&
          ...
          workInProgressHook = null;
          {
            ...
            if (
              ...
              (current2.flags & StaticMask) !==
                (workInProgress2.flags & StaticMask) &&
        ...
        function bailoutHooks(current2, workInProgress2, lanes) {
          ...
          if ((workInProgress2.mode & StrictEffectsMode) !== NoMode) {
            workInProgress2.flags &=
              ~(MountPassiveDev | MountLayoutDev | Passive | Update);
          } else {
        ...
        function updateSyncExternalStore(
          ...
          if (
            inst.getSnapshot !== getSnapshot || snapshotChanged ||
            workInProgressHook !== null &&
        ...
        function mountImperativeHandle(ref, create, deps) {
          ...
          var effectDeps = deps !== null && deps !== void 0
            ? deps.concat([ref])
            : null;
          var fiberFlags = Update;
          {
          ...
          try {
            ...
            if (true) {
              ...
              if (boundary.tag === HostRoot) {
                ...
                var errorBoundaryName = getComponentNameFromFiber(boundary) ||
                  "Anonymous";
                errorBoundaryMessage =
        ...
        function resetSuspendedComponent(sourceFiber, rootRenderLanes) {
          ...
          if (
            ...
            (tag === FunctionComponent || tag === ForwardRef ||
        ...
        function throwException(
          ...
          if (
            ...
            var suspenseBoundary = getNearestSuspenseBoundaryToCapture(
              returnFiber,
            );
            ...
            if (getIsHydrating() && sourceFiber.mode & ConcurrentMode) {
              markDidThrowWhileHydratingDEV();
              var _suspenseBoundary = getNearestSuspenseBoundaryToCapture(
                returnFiber,
              );
        ...
        function updateMemoComponent(
          ...
          if (current2 === null) {
            ...
            if (
              isSimpleFunctionComponent(type) && Component.compare === null &&
          ...
          if (current2 !== null) {
            ...
            if (
              ...
              if (!checkScheduledUpdateOrContext(current2, renderLanes2)) {
                ...
                (current2.flags & ForceUpdateForLegacySuspense) !== NoFlags
              ) {
        ...
        function updateOffscreenComponent(
          ...
          if (nextProps.mode === "hidden" || enableLegacyHidden) {
            if ((workInProgress2.mode & ConcurrentMode) === NoMode) {
              ...
              workInProgress2.lanes = workInProgress2.childLanes = laneToLanes(
                OffscreenLane,
              );
              var _nextState = {
              ...
              var subtreeRenderLanes2 = prevState !== null
                ? prevState.baseLanes
                : renderLanes2;
        ...
        function updateHostComponent(current2, workInProgress2, renderLanes2) {
          ...
          if (isDirectTextChild) {
            ...
            prevProps !== null && shouldSetTextContent(type, prevProps)
          ) {
        ...
        function mountIndeterminateComponent(
          ...
          }
          {
            if (
              ...
              var componentName = getComponentNameFromType(Component) ||
                "Unknown";
          ...
          workInProgress2.flags |= PerformedWork;
          {
            if (
              ...
              var _componentName = getComponentNameFromType(Component) ||
                "Unknown";
          ...
          if (
            ...
            {
              var _componentName2 = getComponentNameFromType(Component) ||
                "Unknown";
        ...
        function validateFunctionComponentInDev(workInProgress2, Component) {
          {
            ...
            if (workInProgress2.ref !== null) {
              ...
              if (debugSource) {
                warningKey = debugSource.fileName + ":" +
            ...
            if (typeof Component.getDerivedStateFromProps === "function") {
              var _componentName3 = getComponentNameFromType(Component) ||
                "Unknown";
              if (
            ...
            if (
              ...
              var _componentName4 = getComponentNameFromType(Component) ||
                "Unknown";
              if (
        ...
        function findLastContentRow(firstChild) {
          ...
          while (row !== null) {
            ...
            if (
              currentRow !== null && findFirstSuspended(currentRow) === null
            ) {
              lastContentRow = row;
            }
            row = row.sibling;
        ...
        function validateRevealOrder(revealOrder) {
          {
            if (
              revealOrder !== void 0 && revealOrder !== "forwards" &&
              revealOrder !== "backwards" && revealOrder !== "together" &&
        ...
        function validateSuspenseListChildren(children, revealOrder) {
          {
            if (
              (revealOrder === "forwards" || revealOrder === "backwards") &&
              children !== void 0 && children !== null && children !== false
            ) {
              if (isArray(children)) {
        ...
        function updateSuspenseListComponent(
          ...
          if (shouldForceFallback) {
            ...
            var didSuspendBefore = current2 !== null &&
        ...
        function beginWork(current2, workInProgress2, renderLanes2) {
          ...
          if (current2 !== null) {
            ...
            var newProps = workInProgress2.pendingProps;
            if (
              oldProps !== newProps || hasContextChanged() ||
              workInProgress2.type !== current2.type
            ) {
              didReceiveUpdate = true;
            } else {
          ...
          switch (workInProgress2.tag) {
            ...
            case FunctionComponent: {
              ...
              var resolvedProps = workInProgress2.elementType === Component
                ? unresolvedProps
            ...
            case ClassComponent: {
              ...
              var _resolvedProps = workInProgress2.elementType === _Component
                ? _unresolvedProps
            ...
            case ForwardRef: {
              ...
              var _resolvedProps2 = workInProgress2.elementType === type
                ? _unresolvedProps2
            ...
            case IncompleteClassComponent: {
              ...
              var _resolvedProps4 = workInProgress2.elementType === _Component2
                ? _unresolvedProps4
          ...
          throw new Error(
            "Unknown unit of work tag (" + workInProgress2.tag +
              "). This error is likely caused by a bug in React. Please file an issue.",
          );
        }
        ...
        function bubbleProperties(completedWork) {
          var didBailout = completedWork.alternate !== null &&
        ...
        function completeDehydratedSuspenseBoundary(
          ...
          if (
            ...
            resetHydrationState();
            workInProgress2.flags |= ForceClientRender | Incomplete |
              ShouldCapture;
            return false;
          }
        ...
        function completeWork(current2, workInProgress2, renderLanes2) {
          ...
          switch (workInProgress2.tag) {
            ...
            case SuspenseComponent: {
              ...
              var prevDidTimeout = current2 !== null &&
                current2.memoizedState !== null;
              if (nextDidTimeout !== prevDidTimeout) {
                if (nextDidTimeout) {
                  ...
                  if ((workInProgress2.mode & ConcurrentMode) !== NoMode) {
                    var hasInvisibleChildContext = current2 === null &&
                      (workInProgress2.memoizedProps
            ...
            case SuspenseListComponent: {
              ...
              if (renderedTail === null) {
                if (!didSuspendAlready) {
                  var cannotBeSuspended = renderHasNotSuspendedYet() &&
                    (current2 === null ||
                      (current2.flags & DidCapture) === NoFlags);
                  ...
                  if (
                    renderState.tail !== null && now() > getRenderTargetTime()
                  ) {
                    workInProgress2.flags |= DidCapture;
                    didSuspendAlready = true;
                    cutOffTailIfNeeded(renderState, false);
                ...
                if (!didSuspendAlready) {
                  ...
                  if (_suspended !== null) {
                    ...
                    if (
                      ...
                      !renderedTail.alternate && !getIsHydrating()
                    ) {
                      bubbleProperties(workInProgress2);
                      return null;
                    }
                    ...
                    now() * 2 - renderState.renderingStartTime >
                      getRenderTargetTime() && renderLanes2 !== OffscreenLane
                  ) {
                    workInProgress2.flags |= DidCapture;
                    didSuspendAlready = true;
                    cutOffTailIfNeeded(renderState, false);
              ...
              case ClassComponent: {
                if (current2 !== null) {
                  ...
                  );
                  {
                    ...
                    if (
                      snapshot === void 0 && !didWarnSet.has(finishedWork.type)
                    ) {
                ...
                }
                {
                  ...
                  if (destroy !== void 0 && typeof destroy !== "function") {
                    ...
                    if (destroy === null) {
                      ...
                      addendum = "\n\nIt looks like you wrote " + hookName +
            ...
            if ((finishedWork.flags & Update) !== NoFlags) {
              switch (finishedWork.tag) {
                case Profiler: {
                  ...
                  var phase = finishedWork.alternate === null
                    ? "mount"
                    : "update";
                  {
        ...
        function commitLayoutEffects_begin(subtreeRoot, root2, committedLanes) {
          ...
          while (nextEffect !== null) {
            ...
            if (fiber.tag === OffscreenComponent && isModernRoot) {
              ...
              var newOffscreenSubtreeIsHidden = isHidden ||
              ...
              if (newOffscreenSubtreeIsHidden) {
                ...
                var current2 = fiber.alternate;
                var wasHidden = current2 !== null &&
                  current2.memoizedState !== null;
                var newOffscreenSubtreeWasHidden = wasHidden ||
        ...
        function commitPassiveUnmountEffects_begin() {
          while (nextEffect !== null) {
            ...
            if (
              (fiber.subtreeFlags & PassiveMask) !== NoFlags && child !== null
            ) {
              child.return = fiber;
              nextEffect = child;
            } else {
        ...
        function scheduleUpdateOnFiber(root2, fiber, lane, eventTime) {
          ...
          if (
            ...
            if (
              lane === SyncLane && executionContext === NoContext &&
        ...
        function performConcurrentWorkOnRoot(root2, didTimeout) {
          ...
          var shouldTimeSlice = !includesBlockingLane(root2, lanes) &&
            !includesExpiredLane(root2, lanes) && !didTimeout;
          ...
          switch (exitStatus) {
            ...
            case RootSuspended: {
              ...
              if (
                ...
                var msUntilTimeout = globalMostRecentFallbackTime +
                  FALLBACK_THROTTLE_MS - now();
          ...
          do {
            ...
            try {
              ...
              if (enableSchedulingProfiler) {
                markComponentRenderStopped();
                if (
                  thrownValue !== null && typeof thrownValue === "object" &&
        ...
        function invokeEffectsInDev(firstChild, fiberFlags, invokeEffectFn) {
          {
            ...
            while (current2 !== null) {
              ...
              if (
                current2 !== subtreeRoot && current2.child !== null &&
        ...
        function warnAboutUpdateOnNotYetMountedFiberInDEV(fiber) {
          {
            ...
            var tag = fiber.tag;
            if (
              tag !== IndeterminateComponent && tag !== HostRoot &&
              tag !== ClassComponent && tag !== FunctionComponent &&
              tag !== ForwardRef && tag !== MemoComponent &&
              tag !== SimpleMemoComponent
            ) {
              return;
            }
          ...
          beginWork$1 = function (current2, unitOfWork, lanes) {
            ...
            try {
              ...
              if (
                ...
                originalError !== null && typeof originalError === "object" &&
              ...
              if (hasCaughtError()) {
                ...
                if (
                  typeof replayError === "object" && replayError !== null &&
        ...
        function warnIfUpdatesNotWrappedWithActDEV(fiber) {
          {
            if (fiber.mode & ConcurrentMode) {
              ...
              if (
                fiber.tag !== FunctionComponent && fiber.tag !== ForwardRef &&
        ...
        function warnIfSuspenseResolutionNotWrappedWithActDEV(root2) {
          {
            if (
              root2.tag !== LegacyRoot && isConcurrentActEnvironment() &&
              ReactCurrentActQueue$1.current === null
            ) {
              error(
        ...
        function isCompatibleFamilyForHotReloading(fiber, element) {
          {
            ...
            if (needsCompareFamilies) {
              ...
              if (
                prevFamily !== void 0 && prevFamily === resolveFamily(nextType)
              ) {
                return true;
              }
            }
        ...
        function isSimpleFunctionComponent(type) {
          return typeof type === "function" && !shouldConstruct$1(type) &&
        ...
        function resetWorkInProgress(workInProgress2, renderLanes2) {
          ...
          if (current2 === null) {
            ...
            workInProgress2.type = current2.type;
            var currentDependencies = current2.dependencies;
            workInProgress2.dependencies = currentDependencies === null
              ? null
              : {
                lanes: currentDependencies.lanes,
                firstContext: currentDependencies.firstContext,
              ...
              default: {
                ...
                throw new Error(
                  "Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) " +
                    ("but got: " + (type == null ? type : typeof type) + "." +
                      info),
                );
              }
            }
        ...
        function createHydrationContainer(
          ...
          var update = createUpdate(eventTime, lane);
          update.callback = callback !== void 0 && callback !== null
            ? callback
            : null;
          ...
          if (options2 !== null && options2 !== void 0) {
            {
              if (options2.hydrate) {
                ...
                if (
                  typeof options2 === "object" && options2 !== null &&
        ...
        function hydrateRoot(container, initialChildren, options2) {
          ...
          var mutableSources = options2 != null && options2.hydratedSources ||
            null;
          var isStrictMode = false;
          var concurrentUpdatesByDefaultOverride = false;
          var identifierPrefix = "";
        ...
        function warnIfReactDOMContainerInDEV(container) {
          {
            if (
              container.nodeType === ELEMENT_NODE && container.tagName &&
        ...
        function unmountComponentAtNode(container) {
          ...
          if (container._reactRootContainer) {
            {
              var rootEl = getReactRootElementInContainer(container);
              var renderedByDifferentReact = rootEl &&
